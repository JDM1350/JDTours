    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') {
            (0, _alerts.showAlert)('error', 'Log-out successfully!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/abhishek1350/clqnmdpsk00rx01o3ce7q0zcp',
    //pitch: 45,
    scrollZoom: false,
...
var signupData = exports.signupData = /*#__PURE__*/function () {
  ...
  return function signupData(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
if (signupFrom) signupFrom.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('password-confirm').value;
  (0, _signup.signupData)(name, email, password, passwordConfirm);
});
